...
RunPod (auto-shutdown): uv run runpod/runpod_ctl.py run 02_basic_convnet_cifar10_examples \\
...
def require_gpu() -> None:
    ...
    print("      uv run runpod/runpod_ctl.py run 02_basic_convnet_cifar10_examples \\")
