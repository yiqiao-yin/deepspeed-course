...
> **Part of [`05_video_speech`](../../README.md) — Video-Speech-to-Speech.**
...
```bash
cd 05_video_speech/01_longcat_omni
...
uv run runpod/runpod_ctl.py recommend 05_video_speech/01_longcat_omni
uv run runpod/runpod_ctl.py run 05_video_speech/01_longcat_omni \
