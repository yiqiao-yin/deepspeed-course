...
uv run runpod/runpod_ctl.py recommend 02_intermediate/01_bayesian_neuralnet
uv run runpod/runpod_ctl.py run 02_intermediate/01_bayesian_neuralnet \
...
This example is sized in `runpod/runpod_ctl.py` as **8 GB VRAM, 2 GPU(s),
20 GB disk**.
