...
WHAT THIS TOPIC IS
------------------
`03_huggingface/02_trl_sft` does supervised fine-tuning: maximise the likelihood of a
...
reinforcement learning. `03_huggingface/06_grpo` next door is the RL answer; this
...
RunPod (auto-shutdown): uv run runpod/runpod_ctl.py run 03_huggingface/05_dpo \\
...
def require_gpu() -> None:
    ...
    print("      uv run runpod/runpod_ctl.py recommend 03_huggingface/05_dpo")
    print("      uv run runpod/runpod_ctl.py run 03_huggingface/05_dpo \\")
...
def main() -> None:
    ...
    print("\n  Next: ../06_grpo/ — when you have a verifier instead")
