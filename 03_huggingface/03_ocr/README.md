...
[`04_video_text/03_token_compression`](../../04_video_text/03_token_compression/) — shrink what
...
uv run runpod/runpod_ctl.py recommend 03_huggingface/03_ocr
uv run runpod/runpod_ctl.py run 03_huggingface/03_ocr \
