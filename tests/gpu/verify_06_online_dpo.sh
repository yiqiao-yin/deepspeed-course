#!/usr/bin/env bash
# =============================================================================
# Multi-GPU smoke test for 03_llms/07_online_dpo.
#
...
# trained here by 03_llms/04_reward_model becomes the preference source.
...
DIR="$HERE/03_llms/07_online_dpo"
RM_DIR="$HERE/03_llms/04_reward_model"
...
echo "=============================================================================="
echo "  03_llms/07_online_dpo — multi-GPU smoke test"
echo "=============================================================================="
"$PY_BIN" - <<'PY'
import torch
