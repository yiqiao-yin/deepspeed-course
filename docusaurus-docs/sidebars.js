    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          label: '03 · LLMs',
          items: [
            'tutorials/llms/overview',
            'tutorials/llms/llm-finetuning',
            'tutorials/llms/glm53-moe-finetuning',
            ...
            'tutorials/llms/rlhf-reward-modeling',
            'tutorials/llms/preference-optimization',
            'tutorials/llms/grpo-training',
            'tutorials/llms/grpo-worked-example',
