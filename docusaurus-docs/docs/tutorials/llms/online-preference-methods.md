...
**Example folder:** [`03_llms/07_online_dpo/`](https://github.com/yiqiao-yin/deepspeed-course/tree/main/03_llms/07_online_dpo) — `--method online_dpo|nash_md|xpo`, ZeRO-3 because it generates during training.
...
`03_llms/07_online_dpo/train_online_dpo.py` tries the stable location and
