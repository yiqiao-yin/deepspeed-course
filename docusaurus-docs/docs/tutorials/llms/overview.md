...
**Rule:** `"auto"` requires HF `Trainer` (or a TRL trainer). With raw `deepspeed.initialize`, every value must be literal. In this course, `03_llms/08_gpt_oss_lora` uses `"auto"` because it runs under `Trainer`; `01_basics/01_neuralnet` uses literals because it does not.
:::
...
|---|---|---|---|
| [TRL Function Calling](/docs/tutorials/llms/trl-function-calling) | Qwen3-0.6B | SFT for tool use | 2 |
| [OCR Vision-Language](/docs/tutorials/llms/ocr-vision-language) | Qwen2-VL-2B | Multimodal LoRA | 2 |
| [RLHF and Reward Modeling](/docs/tutorials/llms/rlhf-reward-modeling) | — | The four-model pipeline (concepts) | — |
| [Preference Optimization](/docs/tutorials/llms/preference-optimization) | — | DPO / IPO / CPO / KTO / ORPO / SimPO | 1 |
| [GRPO Training](/docs/tutorials/llms/grpo-training) | Qwen-1.5B | RL with verifiable rewards | 2 + offload |
| [Online Preference Methods](/docs/tutorials/llms/online-preference-methods) | — | Online DPO / Nash-MD / XPO | 2 |
| [Beyond GRPO](/docs/tutorials/llms/beyond-grpo) | — | Dr. GRPO / DAPO / GSPO | 2 |
| [GPT-OSS Fine-tuning](/docs/tutorials/llms/gpt-oss-finetuning) | gpt-oss-20b | MoE LoRA | 2 |
| [Multi-Agent](/docs/tutorials/llms/multi-agent) | Qwen-1.5B | Multi-agent GRPO (exploratory) | — |
...
- [TRL Function Calling](/docs/tutorials/llms/trl-function-calling) — SFT and completion-only loss masking
