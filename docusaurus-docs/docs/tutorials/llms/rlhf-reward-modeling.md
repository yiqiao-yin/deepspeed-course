...
**Example folder:** [`03_llms/04_reward_model/`](https://github.com/yiqiao-yin/deepspeed-course/tree/main/03_llms/04_reward_model) — `RewardTrainer` + DeepSpeed, plus `reward_modeling.py` (the Bradley-Terry objective on plain tensors, no GPU).
...
[`03_llms/06_grpo/ds_config.json`](https://github.com/yiqiao-yin/deepspeed-course/blob/main/03_llms/06_grpo/ds_config.json)
