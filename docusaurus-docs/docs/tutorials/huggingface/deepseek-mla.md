...
Code: [`03_huggingface/10_deepseek_from_scratch/`](https://github.com/yiqiao-yin/deepspeed-course/tree/main/03_huggingface/10_deepseek_from_scratch)
...
```bash
cd 03_huggingface/10_deepseek_from_scratch
uv sync
