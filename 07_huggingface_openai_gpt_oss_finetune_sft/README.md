...
uv run runpod/runpod_ctl.py recommend 07_huggingface_openai_gpt_oss_finetune_sft
uv run runpod/runpod_ctl.py run 07_huggingface_openai_gpt_oss_finetune_sft \
