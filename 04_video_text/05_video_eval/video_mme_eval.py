...
motivates `../02_qwen25vl/`. A model with frame-index positions
...
RunPod (auto-shutdown): uv run runpod/runpod_ctl.py run 04_video_text/05_video_eval \
