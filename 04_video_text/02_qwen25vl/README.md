...
**Prerequisite:** [`../01_hf_baseline/`](../01_hf_baseline/) — read the LLaVA
...
[`../03_token_compression/`](../03_token_compression/) — otherwise you will
...
uv run runpod/runpod_ctl.py recommend 04_video_text/02_qwen25vl
...
[`../03_token_compression/`](../03_token_compression/) — you have a model that
