...
| Cut tokens 4×, loss degraded | Ratio tuned on more static video than yours | [`../05_video_eval/`](../05_video_eval/) |
...
[`../04_streaming_memory/`](../04_streaming_memory/) — everything here shrinks
