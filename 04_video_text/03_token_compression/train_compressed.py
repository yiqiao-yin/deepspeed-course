...
RunPod (auto-shutdown): uv run runpod/runpod_ctl.py run 04_video_text/03_token_compression \
...
def require_gpu() -> None:
    ...
    print("      uv run runpod/runpod_ctl.py run 04_video_text/03_token_compression \\")
...
def main() -> None:
    ...
    print("\n  Next: ../04_streaming_memory/ — when the video has no length "
