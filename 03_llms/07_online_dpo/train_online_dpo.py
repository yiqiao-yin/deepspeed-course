...
THE GAP THIS FILLS
------------------
`03_llms/05_dpo` learns from a FIXED dataset collected before training
started. `03_llms/06_grpo` samples fresh rollouts and scores them with a
VERIFIER.
...
RunPod (auto-shutdown): uv run runpod/runpod_ctl.py run 03_llms/07_online_dpo \
...
def require_gpu() -> None:
    ...
    print("      uv run runpod/runpod_ctl.py recommend 03_llms/07_online_dpo")
    print("      uv run runpod/runpod_ctl.py run 03_llms/07_online_dpo \\")
