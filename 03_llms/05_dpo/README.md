...
`03_llms/02_trl_sft` does supervised fine-tuning: maximise the likelihood of a
...
reinforcement learning. [`../06_grpo/`](../06_grpo/) is
the RL answer; this is the cheaper one, and for most alignment work it is the
right one.

**Book page:** [Preference Optimization](https://yiqiao-yin.github.io/deepspeed-course/docs/tutorials/llms/preference-optimization)
...
uv run runpod/runpod_ctl.py recommend 03_llms/05_dpo
uv run runpod/runpod_ctl.py run 03_llms/05_dpo \
