...
reinforcement learning. `03_llms/06_grpo` next door is the RL answer; this
...
RunPod (auto-shutdown): uv run runpod/runpod_ctl.py run 03_llms/05_dpo \\
...
def require_gpu() -> None:
    ...
    print("      uv run 03_llms/05_dpo/preference_losses.py")
    print("      uv run tests/test_preference_losses.py    # 58 checks, no GPU")
    print("\n  Check your setup:")
    print("      nvidia-smi")
    print("      ds_report")
    print("\n  Rent a GPU (needs RUNPOD_API_KEY):")
    print("      uv run runpod/runpod_ctl.py recommend 03_llms/05_dpo")
    print("      uv run runpod/runpod_ctl.py run 03_llms/05_dpo \\")
