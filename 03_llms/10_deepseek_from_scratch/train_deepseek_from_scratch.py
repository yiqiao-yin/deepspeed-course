...
RunPod (auto-shutdown): uv run runpod/runpod_ctl.py run 03_llms/10_deepseek_from_scratch \\
...
def require_gpu() -> None:
    ...
    print("      uv run runpod/runpod_ctl.py run 03_llms/10_deepseek_from_scratch \\")
