...
|---|---|---|---|
| — | [`hf_ds_vtt_test2/`](hf_ds_vtt_test2/) | How does video SFT work at all? (LLaVA, 2024) | yes |
| 1 | [`01_qwen25vl_baseline/`](01_qwen25vl_baseline/) | How does a *modern* video model represent time? | yes |
| 2 | [`02_token_compression/`](02_token_compression/) | The clip does not fit. What do I throw away? | partly |
| 3 | [`03_streaming_memory/`](03_streaming_memory/) | The video has no *end*. Now what? | **no** |
| 4 | [`04_video_eval/`](04_video_eval/) | Did compression break understanding? | **no** |
...
```bash
uv run 08_vtt/02_token_compression/token_compression.py   # the token-budget arithmetic
...
25%. It scored 100% once — see [`04_video_eval/`](04_video_eval/).
...
```bash
cd 08_vtt/01_qwen25vl_baseline && sbatch run_deepspeed.sh
```
...
uv run runpod/runpod_ctl.py recommend 08_vtt/02_token_compression
...
|---|---|---|---|---|
| `08_vtt` (LLaVA baseline) | 48 GB | 2 | 120 GB | `deepspeed` |
| `08_vtt/01_qwen25vl_baseline` | 24 GB | 2 | 100 GB | `deepspeed` |
| `08_vtt/02_token_compression` | 24 GB | 1 | 60 GB | `deepspeed` |
| `08_vtt/03_streaming_memory` | 24 GB | 1 | 60 GB | `python` |
| `08_vtt/04_video_eval` | 24 GB | 1 | 60 GB | `python` |
