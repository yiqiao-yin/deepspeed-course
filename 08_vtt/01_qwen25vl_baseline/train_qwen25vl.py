...
See `../02_token_compression/` before you raise `max_frames`.
...
def require_gpu() -> None:
    ...
    print("      uv run runpod/runpod_ctl.py recommend 08_vtt/01_qwen25vl_baseline")
    print("      uv run runpod/runpod_ctl.py run 08_vtt/01_qwen25vl_baseline \\")
...
def main() -> None:
    ...
    parser.add_argument("--max-frames", type=int, default=16,
                        help="Token cost is QUADRATIC in this. See "
                             "../02_token_compression/ before raising it.")
    ...
    print("  next: ../02_token_compression/ — fit more frames in the same VRAM")
